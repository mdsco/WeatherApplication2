...
import com.example.mike.weatherapplication.data.WeatherContract.LocationEntry;
import com.example.mike.weatherapplication.data.WeatherContract.WeatherEntry;
...
//    }
    ...
    public void testGetType() {
        ...
        Context context = shadowApp.getApplicationContext();
        String type = context.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should " +
        ...
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI with location " +
                "should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);
        ...
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date " +
                "should return WeatherEntry.CONTENT_ITEM_TYPE",
        ...
        assertEquals("Error: the LocationEntry CONTENT_URI " +
                "should return LocationEntry.CONTENT_TYPE",
